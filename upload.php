...
$upload_errors = array(
//http://www.php.net/manual/en/features. file-upload.erros.php
	UPLOAD_ERR_OK => "No errors.",
	UPLOAD_ERR_INI_SIZE => "Larager than upload_max_filesize.",
	UPLOAD_ERR_FORM_SIZE => "Larger than form MAX_FILE_SIZE.",
	UPLOAD_ERR_PARTIAL => "Partial upload.",
	UPLOAD_ERR_NO_FILE => "No file.",
	UPLOAD_ERR_NO_TMP_DIR => "No temporary directory.",
	UPLOAD_ERR_CANT_WRITE => "Can't write to disk.",
	UPLOAD_ERR_EXTENSION => "File upload stopped by extentions."
...
if(isset($_POST['submit'])){
	...
	// You will probbaly want to first use the file_exists() to make sure 
	// there isn't already a file  by the same name.

	// move_upload_file will return false if $temp_file is not a valid upload file
...
//
//This form value can be manipulated. You should still use it, but you realy 
